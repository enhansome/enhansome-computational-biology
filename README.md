...
* [JUMP Cell Painting Datasets](https://github.com/jump-cellpainting/datasets) ⭐ 189 | 🐛 26 | 🌐 Shell | 📅 2026-09-14 — Consortium-scale cell imaging perturbation datasets (chemical and genetic) for phenotypic profiling and drug discovery research.
...
* [DeepChem](https://github.com/deepchem/deepchem) ⭐ 6,995 | 🐛 1,181 | 🌐 Python | 📅 2026-08-20 — Deep learning library for drug discovery, quantum chemistry, and materials science.
* [RDKit](https://github.com/rdkit/rdkit) ⭐ 3,586 | 🐛 57 | 🌐 HTML | 📅 2026-09-15 — Cheminformatics software & machine learning toolkit.
...
* [Harmony](https://github.com/immunogenomics/harmony) ⭐ 672 | 🐛 86 | 🌐 R | 📅 2026-06-05 — Fast and scalable integration of single-cell data across datasets, conditions, technologies, and species.
...
* [DeepPurpose](https://github.com/kexinhuang12345/DeepPurpose) ⭐ 1,188 | 🐛 18 | 🌐 Jupyter Notebook | 📅 2024-06-10 — Deep learning library for drug repurposing.
...
* [ClawBio](https://github.com/ClawBio/ClawBio) ⭐ 1,132 | 🐛 22 | 🌐 Python | 📅 2026-09-15 — Bioinformatics-native AI agent skill library with local-first pharmacogenomics, ancestry PCA, semantic similarity, nutrigenomics, and metagenomics skills.
...
* [scGPT](https://github.com/bowang-lab/scGPT) ⭐ 1,628 | 🐛 176 | 🌐 Jupyter Notebook | 📅 2026-04-29 — Transformer-based foundation model pretrained on millions of single-cell profiles.
...
* [GEARS](https://github.com/snap-stanford/GEARS) ⭐ 409 | 🐛 21 | 🌐 Python | 📅 2025-02-01 — Graph-based model for predicting transcriptional responses to single and combinatorial genetic perturbations using biological priors.
...
* [Nicheformer](https://github.com/theislab/nicheformer) ⭐ 174 | 🐛 24 | 🌐 Jupyter Notebook | 📅 2025-11-23 — Foundation model for single-cell and spatial omics using a transformer architecture with positional embeddings to encode spatial cell information.
...
* [totalVI](https://github.com/scverse/scvi-tools) ⭐ 1,690 | 🐛 28 | 🌐 Python | 📅 2026-09-14 — Probabilistic framework for joint analysis of paired scRNA-seq and protein (CITE-seq) data enabling multi-modal cell state representation across single-cell datasets.
* [MultiVI](https://github.com/scverse/scvi-tools) ⭐ 1,690 | 🐛 28 | 🌐 Python | 📅 2026-09-14 — Multi-modal variational autoencoder for integrating paired and unpaired single-cell RNA-seq and ATAC-seq measurements into a unified latent space.
* [GLUE](https://github.com/gao-lab/GLUE) ⭐ 479 | 🐛 24 | 🌐 Python | 📅 2026-02-09 — Graph-Linked Unified Embedding framework for unpaired single-cell multi-omics data integration across RNA, ATAC, methylation, and protein modalities.
...
* [Multigrate](https://github.com/theislab/multigrate) ⭐ 35 | 🐛 4 | 🌐 Python | 📅 2026-09-14 — Asymmetric multi-omics variational autoencoder for integrating single-cell data across RNA, ATAC, and protein modalities with missing-modality support.
...
* [AlphaFold3](https://github.com/google-deepmind/alphafold3) ⭐ 8,556 | 🐛 27 | 🌐 Python | 📅 2026-08-19 — Predicts structures of proteins, nucleic acids, small molecules, and their complexes.
* [Boltz-1](https://github.com/jwohlwend/boltz) ⭐ 4,209 | 🐛 137 | 🌐 Python | 📅 2026-05-29 — Open-source all-atom biomolecular structure prediction model for proteins, nucleic acids, small molecules, and their complexes achieving AlphaFold3-level accuracy.
...
* [OpenFold](https://github.com/aqlaboratory/openfold) ⭐ 3,430 | 🐛 246 | 🌐 Python | 📅 2025-12-16 — Trainable, memory-efficient open-source reproduction of AlphaFold2 enabling custom protein structure prediction workflows.
...
* [ESM3](https://github.com/evolutionaryscale/esm) ⭐ 2,957 | 🐛 67 | 🌐 Jupyter Notebook | 📅 2026-09-08 — Multimodal protein language model that jointly reasons over sequence, structure, and function for generative protein design and engineering.
...
* [Chai-1](https://github.com/chaidiscovery/chai-lab) ⭐ 1,995 | 🐛 93 | 🌐 Python | 📅 2026-06-30 — Unified molecular structure prediction model covering proteins, nucleic acids, small molecules, and complexes.
...
* [Enformer](https://github.com/deepmind/deepmind-research/tree/master/enformer) ⭐ 15,198 | 🐛 359 | 🌐 Jupyter Notebook | 📅 2026-06-17 — Transformer model predicting gene expression from DNA sequence.
* [Evo](https://github.com/evo-design/evo) ⭐ 1,568 | 🐛 41 | 🌐 Python | 📅 2026-03-20 — Long-context genomic foundation model (up to 1M tokens).
* [Nucleotide Transformer](https://github.com/instadeepai/nucleotide-transformer) ⭐ 920 | 🐛 14 | 🌐 Jupyter Notebook | 📅 2026-02-24 — Foundation model for genomic sequences across multiple species.
...
* [DNABERT-2](https://github.com/Zhihan1996/DNABERT_2) ⭐ 514 | 🐛 52 | 🌐 Shell | 📅 2026-01-01 — Improved genome foundation model with efficient tokenization.
...
* [GPN (Genomic Pre-trained Network)](https://github.com/songlab-cal/gpn) ⭐ 374 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2026-09-10 — Masked language model for DNA sequences enabling zero-shot variant effect prediction without requiring functional annotations.
