...
* [JUMP Cell Painting Datasets](https://github.com/jump-cellpainting/datasets) ⭐ 189 | 🐛 26 | 🌐 Shell | 📅 2026-08-31 — Consortium-scale cell imaging perturbation datasets (chemical and genetic) for phenotypic profiling and drug discovery research.
...
* [DeepChem](https://github.com/deepchem/deepchem) ⭐ 6,977 | 🐛 1,178 | 🌐 Python | 📅 2026-08-20 — Deep learning library for drug discovery, quantum chemistry, and materials science.
...
* [DoubletFinder](https://github.com/chris-mcginnis-ucsf/DoubletFinder) ⭐ 562 | 🐛 23 | 🌐 R | 📅 2025-03-21 — Machine learning approach for detecting multiplet (doublet) artifacts in single-cell RNA-seq data.
...
* [BioGPT](https://github.com/microsoft/BioGPT) ⭐ 4,493 | 🐛 75 | 🌐 Python | 📅 2024-07-25 — LLM for biomedical text generation.
* [ClawBio](https://github.com/ClawBio/ClawBio) ⭐ 1,126 | 🐛 23 | 🌐 Python | 📅 2026-09-07 — Bioinformatics-native AI agent skill library with local-first pharmacogenomics, ancestry PCA, semantic similarity, nutrigenomics, and metagenomics skills.
...
* [CASSIA](https://github.com/ElliotXie/CASSIA) ⭐ 104 | 🐛 3 | 🌐 Python | 📅 2026-09-07 — Multi-agent LLM for reference-free, interpretable cell-type annotation of single-cell RNA-seq data, with dedicated annotation, validation, scoring, and reporting agents.
...
* [scGPT](https://github.com/bowang-lab/scGPT) ⭐ 1,622 | 🐛 176 | 🌐 Jupyter Notebook | 📅 2026-04-29 — Transformer-based foundation model pretrained on millions of single-cell profiles.
...
* [UNI](https://github.com/mahmoodlab/UNI) ⭐ 770 | 🐛 32 | 🌐 Jupyter Notebook | 📅 2025-03-26 — General-purpose self-supervised pathology foundation model trained on 100K+ whole-slide images for diverse computational pathology tasks.
...
* [CONCH](https://github.com/mahmoodlab/CONCH) ⭐ 526 | 🐛 16 | 🌐 Python | 📅 2025-03-26 — Vision-language foundation model for computational pathology trained with contrastive captioning on pathology image–text pairs.
...
* [totalVI](https://github.com/scverse/scvi-tools) ⭐ 1,683 | 🐛 24 | 🌐 Python | 📅 2026-09-07 — Probabilistic framework for joint analysis of paired scRNA-seq and protein (CITE-seq) data enabling multi-modal cell state representation across single-cell datasets.
* [MultiVI](https://github.com/scverse/scvi-tools) ⭐ 1,683 | 🐛 24 | 🌐 Python | 📅 2026-09-07 — Multi-modal variational autoencoder for integrating paired and unpaired single-cell RNA-seq and ATAC-seq measurements into a unified latent space.
...
* [Multigrate](https://github.com/theislab/multigrate) ⭐ 35 | 🐛 4 | 🌐 Python | 📅 2026-08-31 — Asymmetric multi-omics variational autoencoder for integrating single-cell data across RNA, ATAC, and protein modalities with missing-modality support.
...
* [AlphaFold3](https://github.com/google-deepmind/alphafold3) ⭐ 8,524 | 🐛 25 | 🌐 Python | 📅 2026-08-19 — Predicts structures of proteins, nucleic acids, small molecules, and their complexes.
* [Boltz-1](https://github.com/jwohlwend/boltz) ⭐ 4,200 | 🐛 142 | 🌐 Python | 📅 2026-05-29 — Open-source all-atom biomolecular structure prediction model for proteins, nucleic acids, small molecules, and their complexes achieving AlphaFold3-level accuracy.
...
* [RFdiffusion](https://github.com/RosettaCommons/RFdiffusion) ⭐ 3,041 | 🐛 245 | 🌐 Python | 📅 2026-07-15 — Generative model for protein backbone design using diffusion.
* [ESM3](https://github.com/evolutionaryscale/esm) ⭐ 2,940 | 🐛 67 | 🌐 Jupyter Notebook | 📅 2026-09-03 — Multimodal protein language model that jointly reasons over sequence, structure, and function for generative protein design and engineering.
...
* [Chai-1](https://github.com/chaidiscovery/chai-lab) ⭐ 1,991 | 🐛 93 | 🌐 Python | 📅 2026-06-30 — Unified molecular structure prediction model covering proteins, nucleic acids, small molecules, and complexes.
* [ProteinMPNN](https://github.com/dauparas/ProteinMPNN) ⭐ 1,843 | 🐛 88 | 🌐 Jupyter Notebook | 📅 2024-08-14 — Deep learning model for protein sequence design given backbone structure.
...
* [Enformer](https://github.com/deepmind/deepmind-research/tree/master/enformer) ⭐ 15,185 | 🐛 358 | 🌐 Jupyter Notebook | 📅 2026-06-17 — Transformer model predicting gene expression from DNA sequence.
* [Evo](https://github.com/evo-design/evo) ⭐ 1,565 | 🐛 41 | 🌐 Python | 📅 2026-03-20 — Long-context genomic foundation model (up to 1M tokens).
