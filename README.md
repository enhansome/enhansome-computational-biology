...
* [DRKG](https://github.com/gnn4dr/DRKG) ⭐ 703 | 🐛 22 | 🌐 Jupyter Notebook | 📅 2022-04-19 — Large-scale biological knowledge graph for drug discovery.
* [Hetionet](https://github.com/hetio/hetionet) ⭐ 357 | 🐛 14 | 🌐 HTML | 📅 2023-04-03 — Heterogeneous network integrating genes, diseases, drugs, pathways, and more.
...
* [ProteinGym](https://github.com/OATML-Markslab/ProteinGym) ⭐ 460 | 🐛 28 | 🌐 HTML | 📅 2026-03-25 — Large-scale benchmark of deep mutational scanning assays for evaluating protein fitness landscape models.
...
* [OpenBioLink](https://github.com/OpenBioLink/OpenBioLink) ⭐ 161 | 🐛 11 | 🌐 Python | 📅 2024-05-03 — Benchmark datasets for biological knowledge graph completion.
...
* [DeepChem](https://github.com/deepchem/deepchem) ⭐ 6,939 | 🐛 1,159 | 🌐 Python | 📅 2026-08-10 — Deep learning library for drug discovery, quantum chemistry, and materials science.
* [RDKit](https://github.com/rdkit/rdkit) ⭐ 3,550 | 🐛 76 | 🌐 HTML | 📅 2026-08-13 — Cheminformatics software & machine learning toolkit.
* [STAR](https://github.com/alexdobin/STAR) ⭐ 2,232 | 🐛 1,004 | 🌐 C | 📅 2025-03-18 — Ultrafast universal RNA-seq aligner with support for spliced alignment and single-cell quantification via STARsolo.
...
* [Chemistry Development Kit](https://github.com/cdk/cdk) ⭐ 598 | 🐛 10 | 🌐 Java | 📅 2026-08-13 — Cheminformatics software & machine learning tools.
...
* [CellCharter](https://github.com/CSOgroup/cellcharter) ⭐ 186 | 🐛 17 | 🌐 Python | 📅 2026-08-10 — Identification and characterization of spatial cell niches from spatial transcriptomics using VAEs and Gaussian mixture models.
...
* [AutoZyme](https://github.com/ElliotXie/autozyme) ⭐ 44 | 🐛 1 | 🌐 Python | 📅 2026-07-10 — Autonomous agentic framework that speeds up bioinformatics software (e.g. Scanpy, Seurat) on CPUs while preserving the original results.
* [ChatSpatial](https://github.com/cafferychen777/ChatSpatial) ⭐ 43 | 🐛 13 | 🌐 Python | 📅 2026-08-13 — MCP server for spatial transcriptomics analysis via natural language.
...
* [DeepPurpose](https://github.com/kexinhuang12345/DeepPurpose) ⭐ 1,177 | 🐛 18 | 🌐 Jupyter Notebook | 📅 2024-06-10 — Deep learning library for drug repurposing.
...
* [DiffDock](https://github.com/gcorso/DiffDock) ⭐ 1,564 | 🐛 132 | 🌐 Python | 📅 2025-05-02 — Diffusion generative model for molecular docking, predicting the binding pose of small molecules to protein targets.
...
* [BioGPT](https://github.com/microsoft/BioGPT) ⭐ 4,490 | 🐛 74 | 🌐 Python | 📅 2024-07-25 — LLM for biomedical text generation.
* [ClawBio](https://github.com/ClawBio/ClawBio) ⭐ 1,099 | 🐛 19 | 🌐 Python | 📅 2026-08-12 — Bioinformatics-native AI agent skill library with local-first pharmacogenomics, ancestry PCA, semantic similarity, nutrigenomics, and metagenomics skills.
...
* [scGPT](https://github.com/bowang-lab/scGPT) ⭐ 1,615 | 🐛 176 | 🌐 Jupyter Notebook | 📅 2026-04-29 — Transformer-based foundation model pretrained on millions of single-cell profiles.
...
* [GEARS](https://github.com/snap-stanford/GEARS) ⭐ 391 | 🐛 21 | 🌐 Python | 📅 2025-02-01 — Graph-based model for predicting transcriptional responses to single and combinatorial genetic perturbations using biological priors.
* [scBERT](https://github.com/TencentAILabHealthcare/scBERT) ⭐ 360 | 🐛 26 | 🌐 Python | 📅 2023-12-13 — BERT-based foundation model pretrained on large-scale scRNA-seq data for cell type annotation.
* [UCE](https://github.com/snap-stanford/UCE) ⭐ 324 | 🐛 2 | 🌐 Python | 📅 2026-07-08 — Universal Cell Embeddings: zero-shot single-cell embedding model trained on 36M cells across species, tissues, and assays without fine-tuning.
* [SATURN](https://github.com/snap-stanford/SATURN) ⭐ 169 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2024-07-03 — Transformer-based model integrating gene expression and protein sequences via a protein language model to learn unified multi-species cell embeddings.
...
* [UNI](https://github.com/mahmoodlab/UNI) ⭐ 765 | 🐛 32 | 🌐 Jupyter Notebook | 📅 2025-03-26 — General-purpose self-supervised pathology foundation model trained on 100K+ whole-slide images for diverse computational pathology tasks.
...
* [CONCH](https://github.com/mahmoodlab/CONCH) ⭐ 522 | 🐛 16 | 🌐 Python | 📅 2025-03-26 — Vision-language foundation model for computational pathology trained with contrastive captioning on pathology image–text pairs.
...
* [DeepSpot-M](https://github.com/ratschlab/DeepSpotM) ⭐ 36 | 🐛 1 | 🌐 Python | 📅 2026-08-12 — Multimodal foundation model for transcriptome-wide virtual spatial transcriptomics from histology.
...
* [totalVI](https://github.com/scverse/scvi-tools) ⭐ 1,676 | 🐛 24 | 🌐 Python | 📅 2026-08-12 — Probabilistic framework for joint analysis of paired scRNA-seq and protein (CITE-seq) data enabling multi-modal cell state representation across single-cell datasets.
* [MultiVI](https://github.com/scverse/scvi-tools) ⭐ 1,676 | 🐛 24 | 🌐 Python | 📅 2026-08-12 — Multi-modal variational autoencoder for integrating paired and unpaired single-cell RNA-seq and ATAC-seq measurements into a unified latent space.
...
* [MOFA+](https://github.com/bioFAM/MOFA2) ⭐ 415 | 🐛 68 | 🌐 R | 📅 2026-08-05 — Multi-Omics Factor Analysis framework identifying shared axes of variation across bulk and single-cell datasets including RNA, ATAC, proteomics, methylation, and copy number.
...
* [BABEL](https://github.com/wukevin/babel) ⭐ 50 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2023-07-17 — Cross-modality translation model enabling prediction between scRNA-seq and scATAC-seq profiles without requiring paired single-cell measurements.
...
* [scArches](https://github.com/theislab/scarches) ⭐ 407 | 🐛 66 | 🌐 Jupyter Notebook | 📅 2026-06-26 — Transfer learning framework for mapping new single-cell datasets onto pre-trained reference atlases across batches, conditions, and modalities.
...
* [AlphaFold3](https://github.com/google-deepmind/alphafold3) ⭐ 8,447 | 🐛 16 | 🌐 Python | 📅 2026-08-11 — Predicts structures of proteins, nucleic acids, small molecules, and their complexes.
...
* [Boltz-1](https://github.com/jwohlwend/boltz) ⭐ 4,159 | 🐛 155 | 🌐 Python | 📅 2026-05-29 — Open-source all-atom biomolecular structure prediction model for proteins, nucleic acids, small molecules, and their complexes achieving AlphaFold3-level accuracy.
* [OpenFold](https://github.com/aqlaboratory/openfold) ⭐ 3,413 | 🐛 246 | 🌐 Python | 📅 2025-12-16 — Trainable, memory-efficient open-source reproduction of AlphaFold2 enabling custom protein structure prediction workflows.
* [RFdiffusion](https://github.com/RosettaCommons/RFdiffusion) ⭐ 3,012 | 🐛 245 | 🌐 Python | 📅 2026-07-15 — Generative model for protein backbone design using diffusion.
* [ESM3](https://github.com/evolutionaryscale/esm) ⭐ 2,899 | 🐛 71 | 🌐 Jupyter Notebook | 📅 2026-07-28 — Multimodal protein language model that jointly reasons over sequence, structure, and function for generative protein design and engineering.
* [RoseTTAFold](https://github.com/RosettaCommons/RoseTTAFold) ⭐ 2,252 | 🐛 100 | 🌐 Python | 📅 2024-02-15 — Three-track neural network for protein structure prediction.
* [Chai-1](https://github.com/chaidiscovery/chai-lab) ⭐ 1,977 | 🐛 93 | 🌐 Python | 📅 2026-06-30 — Unified molecular structure prediction model covering proteins, nucleic acids, small molecules, and complexes.
* [ProteinMPNN](https://github.com/dauparas/ProteinMPNN) ⭐ 1,824 | 🐛 88 | 🌐 Jupyter Notebook | 📅 2024-08-14 — Deep learning model for protein sequence design given backbone structure.
...
* [Enformer](https://github.com/deepmind/deepmind-research/tree/master/enformer) ⭐ 15,150 | 🐛 341 | 🌐 Jupyter Notebook | 📅 2026-06-17 — Transformer model predicting gene expression from DNA sequence.
* [Evo](https://github.com/evo-design/evo) ⭐ 1,552 | 🐛 41 | 🌐 Python | 📅 2026-03-20 — Long-context genomic foundation model (up to 1M tokens).
...
* [HyenaDNA](https://github.com/HazyResearch/hyena-dna) ⭐ 802 | 🐛 38 | 🌐 Assembly | 📅 2025-04-22 — Long-range genomic foundation model handling sequences up to 1M tokens with sub-quadratic attention.
...
* [GPN (Genomic Pre-trained Network)](https://github.com/songlab-cal/gpn) ⭐ 351 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-07-25 — Masked language model for DNA sequences enabling zero-shot variant effect prediction without requiring functional annotations.
