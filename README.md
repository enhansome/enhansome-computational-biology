...
* [JUMP Cell Painting Datasets](https://github.com/jump-cellpainting/datasets) ⭐ 188 | 🐛 26 | 🌐 Shell | 📅 2026-08-24 — Consortium-scale cell imaging perturbation datasets (chemical and genetic) for phenotypic profiling and drug discovery research.
...
* [DeepChem](https://github.com/deepchem/deepchem) ⭐ 6,959 | 🐛 1,165 | 🌐 Python | 📅 2026-08-20 — Deep learning library for drug discovery, quantum chemistry, and materials science.
* [RDKit](https://github.com/rdkit/rdkit) ⭐ 3,562 | 🐛 65 | 🌐 HTML | 📅 2026-08-24 — Cheminformatics software & machine learning toolkit.
* [STAR](https://github.com/alexdobin/STAR) ⭐ 2,239 | 🐛 1,006 | 🌐 C | 📅 2025-03-18 — Ultrafast universal RNA-seq aligner with support for spliced alignment and single-cell quantification via STARsolo.
...
* [CellOT](https://github.com/bunnech/cellot) ⭐ 180 | 🐛 12 | 🌐 Python | 📅 2024-10-31 — Neural optimal transport framework for predicting single-cell responses to drug and genetic perturbations.
...
* [DiffSBDD](https://github.com/arneschneuing/DiffSBDD) ⭐ 528 | 🐛 30 | 🌐 Python | 📅 2025-06-25 — Equivariant diffusion model for structure-based drug design that generates molecules and binding conformations for protein targets.
...
* [BioGPT](https://github.com/microsoft/BioGPT) ⭐ 4,488 | 🐛 75 | 🌐 Python | 📅 2024-07-25 — LLM for biomedical text generation.
* [ClawBio](https://github.com/ClawBio/ClawBio) ⭐ 1,115 | 🐛 24 | 🌐 Python | 📅 2026-08-24 — Bioinformatics-native AI agent skill library with local-first pharmacogenomics, ancestry PCA, semantic similarity, nutrigenomics, and metagenomics skills.
...
* [scGPT](https://github.com/bowang-lab/scGPT) ⭐ 1,618 | 🐛 176 | 🌐 Jupyter Notebook | 📅 2026-04-29 — Transformer-based foundation model pretrained on millions of single-cell profiles.
* [scFoundation](https://github.com/biomap-research/scFoundation) ⭐ 426 | 🐛 31 | 🌐 Jupyter Notebook | 📅 2025-11-23 — Large-scale foundation model for single-cell gene expression, enabling multiple downstream tasks.
* [GEARS](https://github.com/snap-stanford/GEARS) ⭐ 398 | 🐛 21 | 🌐 Python | 📅 2025-02-01 — Graph-based model for predicting transcriptional responses to single and combinatorial genetic perturbations using biological priors.
...
* [totalVI](https://github.com/scverse/scvi-tools) ⭐ 1,681 | 🐛 24 | 🌐 Python | 📅 2026-08-24 — Probabilistic framework for joint analysis of paired scRNA-seq and protein (CITE-seq) data enabling multi-modal cell state representation across single-cell datasets.
* [MultiVI](https://github.com/scverse/scvi-tools) ⭐ 1,681 | 🐛 24 | 🌐 Python | 📅 2026-08-24 — Multi-modal variational autoencoder for integrating paired and unpaired single-cell RNA-seq and ATAC-seq measurements into a unified latent space.
...
* [AlphaFold3](https://github.com/google-deepmind/alphafold3) ⭐ 8,490 | 🐛 16 | 🌐 Python | 📅 2026-08-19 — Predicts structures of proteins, nucleic acids, small molecules, and their complexes.
* [Boltz-1](https://github.com/jwohlwend/boltz) ⭐ 4,175 | 🐛 154 | 🌐 Python | 📅 2026-05-29 — Open-source all-atom biomolecular structure prediction model for proteins, nucleic acids, small molecules, and their complexes achieving AlphaFold3-level accuracy.
...
* [ESM3](https://github.com/evolutionaryscale/esm) ⭐ 2,921 | 🐛 72 | 🌐 Jupyter Notebook | 📅 2026-08-24 — Multimodal protein language model that jointly reasons over sequence, structure, and function for generative protein design and engineering.
* [RoseTTAFold](https://github.com/RosettaCommons/RoseTTAFold) ⭐ 2,257 | 🐛 99 | 🌐 Python | 📅 2024-02-15 — Three-track neural network for protein structure prediction.
...
* [Enformer](https://github.com/deepmind/deepmind-research/tree/master/enformer) ⭐ 15,167 | 🐛 358 | 🌐 Jupyter Notebook | 📅 2026-06-17 — Transformer model predicting gene expression from DNA sequence.
* [Evo](https://github.com/evo-design/evo) ⭐ 1,559 | 🐛 41 | 🌐 Python | 📅 2026-03-20 — Long-context genomic foundation model (up to 1M tokens).
* [Nucleotide Transformer](https://github.com/instadeepai/nucleotide-transformer) ⭐ 909 | 🐛 13 | 🌐 Jupyter Notebook | 📅 2026-02-24 — Foundation model for genomic sequences across multiple species.
...
* [GPN (Genomic Pre-trained Network)](https://github.com/songlab-cal/gpn) ⭐ 353 | 🐛 15 | 🌐 Python | 📅 2026-08-24 — Masked language model for DNA sequences enabling zero-shot variant effect prediction without requiring functional annotations.
